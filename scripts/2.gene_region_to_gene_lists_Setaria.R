...
##Get Path
##
##species_path <- setwd("/shares/tmockler_share/private/Data/G2g/Setaria/")
wd_path <- getwd()
...
##gene_location <- read.table(file = paste(species_path, "resources/Setaria_viridis_gene_locations/Sviridis_311_v1.1.gene_locations.txt", sep="/"), header = T, sep = "\t")
gene_location <- read.table(file = "/shares/tmockler_share/private/Data/G2g/Setaria/resources/Setaria_viridis_gene_locations/Sviridis_311_v1.1.gene_locations.txt", header = T, sep = "\t")
