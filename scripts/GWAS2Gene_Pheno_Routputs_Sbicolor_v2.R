...
gene_db <- as.data.frame(read_feather("/shares/tmockler_share/private/Data/G2g/Sbicolor/resources/R_resources/Sbicolor_313_v3.1.gene.gff.feather"))

annotation_db <- as.data.frame(read_feather("/shares/tmockler_share/private/Data/G2g/Sbicolor/resources/R_resources/Sbicolor_454_v3.1.1.annotation.feather"))

PAV_subpops <- read.csv("/shares/tmockler_share/private/Data/G2g/Sbicolor/resources/R_resources/BAP_pop_assignments_q8.csv")
PAV_Calls <- as.data.frame(read_feather("/shares/tmockler_share/private/Data/G2g/Sbicolor/resources/R_resources/BAP_PAV_calls.feather"))
