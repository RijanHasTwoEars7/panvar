...
tabix -h resources/snpeff_vcfs/hmp321_agpv4_chr${SNP_CHR}.snpeff.vcf.gz ${SNP_CHR}:${SNP_TEMP_REGION_START}-${SNP_TEMP_REGION_STOP} > ${PROJECT_FOLDER}/${SNP_CHR}_${SNP_LOCATION}_temp_region.vcf
