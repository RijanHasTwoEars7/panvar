...
#> [1] "/tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/RtmpN2tWi5/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Sep  8 16:18:59 2026
#> 15989 MiB RAM detected, ~14186 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Sep  8 16:18:59 2026
#> QC was successful, output stored at /tmp/RtmpN2tWi5/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/RtmpN2tWi5
...
#> Results are stored at Working Directory: /tmp/RtmpN2tWi5 
#> End: 2026-09-08 16:19:00 UTC 
...
names(tables)
#> [1] "gwas"        "anno"        "window.snps" "key.snp"     "qtl.snps"
head(tables$gwas)
#> # A tibble: 6 × 13
#> # Rowwise: 
