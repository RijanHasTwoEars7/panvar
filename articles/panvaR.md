...
#> [1] "/tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1"
...
#> Logging to /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1.log.
#> Options in effect:
#>   --allow-extra-chr
#>   --bfile /home/runner/work/_temp/Library/panvaR/extdata/Setaria_shattering_example_pruned
#>   --geno 0.1
#>   --keep /tmp/Rtmp0DDkyS/Panvar_list.of.samples.with.phenotype_shattering.txt
#>   --maf 0.05
#>   --make-bed
#>   --out /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1
#>   --set-all-var-ids @-#
#> 
#> Start time: Tue Sep  8 21:39:46 2026
#> 15989 MiB RAM detected, ~14006 available; reserving 7994 MiB for main
#> workspace.
...
#> Writing /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1.fam ... done.
#> Writing /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1.bim ... done.
#> Writing /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1.bed ... 0%done.
#> End time: Tue Sep  8 21:39:46 2026
#> QC was successful, output stored at /tmp/Rtmp0DDkyS/PanvarExample_PlinkQC_maf0.05_missing0.1
...
panvar_mvp_gwas(inputs.dir = options()$panvar_outdir,
                ...
                gwas.model = "GLM",
                output.manhattan = T)
#> Searching for prefix: PanvarExample in directory: /tmp/Rtmp0DDkyS
...
#> Results are stored at Working Directory: /tmp/Rtmp0DDkyS 
#> End: 2026-09-08 21:39:48 UTC 
