...
#> Error in plotly_panvar(panvar.table.list = tables, pvals.in.log = FALSE,     window = 25, sig.line = 6): annotation.point.variable: LD not found in panvar.table.list$anno
