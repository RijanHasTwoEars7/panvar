...
- use.arrows:
  ...
  boolean, if TRUE, use
  [gggenes::geom_gene_arrow](https://wilkox.org/gggenes/reference/geom_gene_arrow.html)
  to draw representations of genes. If the direction is encoded in
  another variable, supply that to
