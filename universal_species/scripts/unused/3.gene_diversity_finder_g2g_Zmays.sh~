...
if grep -Fq "$GENE_ID" ${BASE_DIR}/resources/Setaria_viridis_gene_locations/Sviridis_311_v1.1.gene_locations.txt 
then

##Get relevant info for gene of interest

gene_info=$(grep ${GENE_ID} ${BASE_DIR}/resources/Setaria_viridis_gene_locations/Sviridis_311_v1.1.gene_locations.txt)
...
tabix -h ${BASE_DIR}/resources/Setaria_viridis_VCF_files/Setaria_viridis_1.1.snpEff.vcf.gz ${gene_cord} | grep -E "#|${GENE_ID}" > ${CURRENT_DIR}/${FOLDER_NAME}/results/gene_hits/$OUTPUT_NAME/${GENE_ID}_temp.vcf
