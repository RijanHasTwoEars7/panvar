...
gene_location <- read.table(file = "/shares/tmockler_share/private/Data/G2g/Sbicolor/resources/BAP_gene_locations/Sbicolor_313_v3_1_gene_locations_extended.txt", header = T, sep = "\t")
